...
**Phase 1 (C01–C03 + CW 05 print):** filling Official Word templates and
downloading those `.docx` files.

**Phase 2 (C01–C03 + CW 05 scan blanks):** blank PNGs and atlas boxes are
measured on those Word renders (`ATLAS_VERSION` `word-c01-c02-c03-cw05-v2.3`).
C03 uses **page 1 only**. CW 05 Word exports **4 pages** (old NPO PDF had 3).
