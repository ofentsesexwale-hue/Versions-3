...
CLASSIFY_KEYWORDS = {
    ...
    'family_care_plan': ['FAMILY CARE PLAN', 'NEEDS / ACTIONS', 'OVERALL GOAL', 'IDENTIFIED NEEDS', 'FAMILY REGISTRATION'],
    'hiv_risk': ['HIV RISK ASSESSMENT', 'HIV RISK', 'PART 1: HIV SCREENING', 'RISK INDICATORS'],
    'hivstat': ['HTS TRACKING', 'BENEFICIARY DETAILS', 'ON ART', 'VIRAL LOAD'],
    'consent': ['CAREGIVER CONSENT', 'CHILD ASSENT', 'SUPPORTIVE REFERRAL', 'HIV TESTING'],
    'client_referral': ['CLIENT REFERRAL FORM', 'PART A', 'CODES FOR SERVICES REQUIRED'],
